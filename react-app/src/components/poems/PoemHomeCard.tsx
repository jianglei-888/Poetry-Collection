    ...
    >
      <article className="relative animate-[poem-float_8s_ease-in-out_infinite] px-4 py-3 transition duration-700 ease-out group-hover:scale-[1.07]">
        ...
        <div className="relative">
          <h2 className="animate-[poem-glow_6.5s_ease-in-out_infinite] text-[1.45rem] leading-tight text-[#fffaf0]/96 drop-shadow-[0_0_18px_rgba(255,245,227,0.36)] transition duration-700 group-hover:text-white group-hover:drop-shadow-[0_0_30px_rgba(255,244,214,0.7)] sm:text-[1.7rem] lg:text-[1.95rem]">
            《{poem.Title}》
          </h2>
